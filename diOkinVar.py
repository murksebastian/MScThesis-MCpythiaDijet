...
def drawHist(alphaOrder,c,D,colourN,styleN,L,label,ofilename):
	for keyN,dKey in enumerate(sorted(D),start=1):
		...
		h.Draw("same")
		if ("invM" in dKey):
			h.SetTitle("dijet invariant mass distribution")
...
drawHist(alphaOrder,canvinvM,di1DinvM,1,20,LinvM,"dijet #Omicron(#alpha_{s}) = 1 (@LO)","Results/KinVarPlots/invM_di0_di1.pdf")
drawHist(alphaOrder,canvphi,di1Dphi,1,20,Lphi,"dijet #Omicron(#alpha_{s}) = 1 (@LO)","Results/KinVarPlots/phi_di0_di1.pdf")
drawHist(alphaOrder,canvpT,di1DpT,1,20,LpT,"dijet #Omicron(#alpha_{s}) = 1 (@LO)","Results/KinVarPlots/pT_di0_di1.pdf")
drawHist(alphaOrder,canvy,di1Dy,1,20,Ly,"dijet #Omicron(#alpha_{s}) = 1 (@LO)","Results/KinVarPlots/y_di0_di1.pdf")
drawHist(alphaOrder,canvyB,di1DyB,1,20,LyB,"dijet #Omicron(#alpha_{s}) = 1 (@LO)","Results/KinVarPlots/yB_di0_di1.pdf")
drawHist(alphaOrder,canvyS,di1DyS,1,20,LyS,"dijet #Omicron(#alpha_{s}) = 1 (@LO)","Results/KinVarPlots/yS_di0_di1.pdf")
